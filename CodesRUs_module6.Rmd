...
```{r, "plotting inter-specific data", fig.cap="Linear Model Depicting Log Tranformed Mean Mass (x-axis) vs Log Transformed Mean Temperature Change (y-axis) From Our Human Data Set"}
...
```{r, "plotting intra-specific data without log transformation", fig.cap="Linear Model Depicting Mean Mass (x-axis) vs Mean Temperature Change (y-axis) of Each Species From Data Set (mammals)"}
...
```{r, "plotting intra-specific data with log transformations", fig.cap="Linear Model Depicting Log Tranformed Mean Mass (x-axis) vs Log Transformed Mean Temperature Change (y-axis) of Each Species From Data Set (mammals)"}

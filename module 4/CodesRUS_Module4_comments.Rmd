...
<div class="comment">
Not sure why this bulleted list is here. This is meant to mirror a scientific paper.
</div>
...
<div class="comment">
References will automatically be placed at the end of the doc. No need to add the tags nor a comment as to the context. Again, this mirrors what a paper would look like. 
</div>
...
<!-- CPK. Couldn't run this chunk bc of missing quote after "AIC. -->
...
<div class="comment">
This ins't what the prompt was asking for. We needed the AIC table. -1 pt

The code chunks should be placed in the appropriate places. If they produce results (figures, tables, etc.), they should go near/in the results.

Couldn't knit because bib file in YAML header doesn't match name of the bib file in directory. -1pt

Good work. Just be careful to read the prompts closely. 8/10
</div>
